...
const Pagination = ({ pages, setCurrentPage, currentEntities, sortedEntities }) => {
    ...
    return (
        <div className="clearfix">
            <div className="hint-text"><b>{currentEntities.length}</b> из <b>{sortedEntities.length}</b> записей</div>
